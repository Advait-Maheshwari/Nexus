...
Nexus should feel cinematic, but its architecture should remain boring where it matters. Project data, permissions, analytics, and AI jobs live in explicit services and schemas. The frontend renders that same data as dashboards, galaxies, DNA timelines, city builders, and calendars.
...
- `DNATimeline`: milestones/tasks as rotating temporal nodes.
...
- DNA nodes reflect milestones, tasks, delays, and AI risk flags.
